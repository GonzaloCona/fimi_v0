...
public class RootRest {
	...
	//@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public salidaStndr InsertNoticia(@MatrixParam("seccion") String seccion,@MatrixParam("contenido") String contenido,@MatrixParam("titulo") String titulo,@MatrixParam("foto") String foto,@MatrixParam("tipo") int tipo,@MatrixParam("estado") int estado,@MatrixParam("fecha") Date fecha){
